  ...
  "node_modules/@daypilot/daypilot-lite-react/daypilot-react.min.js"(exports, module) {
    ...
    if (function() {
      function e(e2) {
        ...
        if (t2[e2])
          return DayPilot.Stats.cacheHitsTicks += 1, t2[e2];
      ...
      if ("undefined" == typeof DayPilot.$) {
        "undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), DayPilot.$ = function(e2) {
        ...
        }, DayPilot.isKhtml = navigator && navigator.userAgent && navigator.userAgent.indexOf("KHTML") !== -1, DayPilot.isIE = navigator && navigator.userAgent && navigator.userAgent.indexOf("MSIE") !== -1, DayPilot.mo2 = function(e2, t2) {
          if (t2 = t2 || window.event, "undefined" != typeof t2.offsetX) {
            var i2 = { x: t2.offsetX + 1, y: t2.offsetY + 1 };
            if (!e2)
              return i2;
            for (var a2 = t2.srcElement; a2 && a2 !== e2; )
              "SPAN" !== a2.tagName && (i2.x += a2.offsetLeft, a2.offsetTop > 0 && (i2.y += a2.offsetTop - a2.scrollTop)), a2 = a2.offsetParent;
            return a2 ? i2 : null;
          }
          if ("undefined" != typeof t2.layerX) {
            ...
            if (!e2)
              return i2;
            for (var a2 = t2.target; a2 && "absolute" !== a2.style.position && "relative" !== a2.style.position; )
              a2 = a2.parentNode, DayPilot.isKhtml && (i2.y += a2.scrollTop);
            for (; a2 && a2 !== e2; )
              i2.x += a2.offsetLeft, i2.y += a2.offsetTop - a2.scrollTop, a2 = a2.offsetParent;
            return a2 ? i2 : null;
          }
          return null;
          ...
          if (a2)
            if (e2) {
              ...
              i2 = { x: a2.x, y: a2.y };
          else if (i2 = DayPilot.mo2(e2, t2), !i2)
            return null;
          ...
          return e2.innerHTML = "<!--[if IE 9]><i></i><![endif]-->", 1 === e2.getElementsByTagName("i").length;
        }(), DayPilot.browser.ielt9 = function() {
          var e2 = document.createElement("div");
          return e2.innerHTML = "<!--[if lt IE 9]><i></i><![endif]-->", 1 === e2.getElementsByTagName("i").length;
        }(), DayPilot.browser.hover = !window.matchMedia("(any-hover: none)").matches, DayPilot.touch = {}, DayPilot.page = function(e2) {
          var t2 = e2.changedTouches && e2.changedTouches[0] ? e2.changedTouches[0] : e2;
          return "undefined" == typeof t2.pageX || DayPilot.browser.ie ? "undefined" != typeof e2.clientX && document.body && document.documentElement ? { x: e2.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, y: e2.clientY + document.body.scrollTop + document.documentElement.scrollTop } : null : { x: t2.pageX, y: t2.pageY };
          ...
          for (var i2 = { x: e2.offsetLeft, y: e2.offsetTop, w: e2.clientWidth, h: e2.clientHeight, toString: function() {
            ...
            e2 = e2.offsetParent, i2.x -= e2.scrollLeft, i2.y -= e2.scrollTop, t2 && (i2.x < 0 && (i2.w += i2.x, i2.x = 0), i2.y < 0 && (i2.h += i2.y, i2.y = 0), e2.scrollLeft > 0 && i2.x + i2.w > e2.clientWidth && (i2.w -= i2.x + i2.w - e2.clientWidth), e2.scrollTop && i2.y + i2.h > e2.clientHeight && (i2.h -= i2.y + i2.h - e2.clientHeight)), i2.x += e2.offsetLeft, i2.y += e2.offsetTop;
          ...
          e2.setAttribute("type", "text/css"), e2.styleSheet || e2.appendChild(document.createTextNode("")), (document.head || document.getElementsByTagName("head")[0]).appendChild(e2);
          var t2 = !!e2.styleSheet, i2 = {};
          return i2.rules = [], i2.commit = function() {
            t2 && (e2.styleSheet.cssText = this.rules.join("\n"));
          }, i2.add = function(i3, a2, n2) {
            return t2 ? void this.rules.push(i3 + "{" + a2 + "}") : void (e2.sheet.insertRule ? ("undefined" == typeof n2 && (n2 = e2.sheet.cssRules.length), e2.sheet.insertRule(i3 + "{" + a2 + "}", n2)) : e2.sheet.addRule && e2.sheet.addRule(i3, a2, n2));
          }, i2;
          ...
          if (!t2)
            var t2 = [];
          for (var i2 = 0; e2.children && i2 < e2.children.length; i2++)
            t2.push(e2.children[i2]), DayPilot.ac(e2.children[i2], t2);
          return t2;
          ...
          if (n2)
            for (i2 = n2.length, t2 = 0; t2 < i2; t2 += 1)
              n2[t2] && (a2 = n2[t2].name, "function" == typeof e2[a2] && (e2[a2] = null));
          if (n2 = e2.childNodes)
            for (i2 = n2.length, t2 = 0; t2 < i2; t2 += 1) {
          ...
          n2 && (n2.open("POST", e2, true), n2.setRequestHeader("Content-type", "text/plain"), n2.onreadystatechange = function() {
            if (4 === n2.readyState)
              return 200 !== n2.status && 304 !== n2.status ? void (a2 ? a2(n2) : window.console && console.log("HTTP error " + n2.status)) : void t2(n2);
          ...
          t2.open(n2, s, true), t2.setRequestHeader("Content-type", l), DayPilot.Util.ownPropsAsArray(d).forEach(function(e3) {
            ...
            if (4 === t2.readyState)
              if (200 === t2.status || 201 === t2.status || 204 === t2.status || 304 === t2.status) {
                var e3 = {};
                ...
                window.console && console.log("HTTP error " + t2.status);
          ...
          if ("undefined" == typeof i2)
            for (var a2 in e2)
              e2.hasOwnProperty(a2) && "undefined" != typeof e2[a2] && (t2[a2] = e2[a2]);
          else
        ...
        DayPilot.Areas.showAreas = function(e2, t2, i2, a2, n2) {
          ...
          if ("undefined" != typeof i2.style && d.setAttribute("style", i2.style), d.style.position = "absolute", d.style.width = s(c), d.style.height = s(u), d.style.right = s(i2.right), d.style.top = s(i2.top), d.style.left = s(i2.left), d.style.bottom = s(i2.bottom), "undefined" != typeof i2.html || "undefined" != typeof i2.text)
            d.innerHTML = DayPilot.Util.escapeTextHtml(i2.text, i2.html);
          else if (i2.icon) {
          ...
          if (h && (d.className = h), i2.toolTip && d.setAttribute("title", i2.toolTip), i2.backColor && (d.style.background = i2.backColor), i2.background && (d.style.background = i2.background), i2.fontColor && (d.style.color = i2.fontColor), i2.padding && (d.style.padding = i2.padding + "px", d.style.boxSizing = "border-box"), i2.verticalAlignment)
            switch (d.style.display = "flex", i2.verticalAlignment) {
              case "center":
          ...
          if (i2.horizontalAlignment)
            switch (d.style.display = "flex", i2.horizontalAlignment) {
              case "right":
          ...
          if ("ResizeEnd" === i2.action || "ResizeStart" === i2.action || "Move" === i2.action) {
            ...
            if (t2.calendar.isScheduler || t2.calendar.isMonth)
              switch (i2.action) {
                case "ResizeEnd":
          ...
          if (e2 && e2 && e2.active) {
            ...
            if (i2 && i2.children && t2) {
              ...
              if (~DayPilot.indexOf(i2.children, n2))
                return;
            }
            if (!a2 || 0 === a2.length)
              return void (e2.active = null);
          ...
          if (DayPilot.Areas.all && 0 !== DayPilot.Areas.all.length)
            for (var t2 = 0; t2 < DayPilot.Areas.all.length; t2++)
              DayPilot.Areas.hideAreas(DayPilot.Areas.all[t2], e2);
        }, DayPilot.Exception = function(e2) {
          return new Error(e2);
        }, DayPilot.Locale = function(e2, t2) {
          if (this.id = e2, this.dayNames = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], this.dayNamesShort = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], this.monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], this.datePattern = "M/d/yyyy", this.timePattern = "H:mm", this.dateTimePattern = "M/d/yyyy H:mm", this.timeFormat = "Clock12Hours", this.weekStarts = 0, t2)
            for (var i2 in t2)
              this[i2] = t2[i2];
          ...
          this.f = [], this.i = [], this.j = {}, this.selectedClass = null, this.k = null, this.l = DayPilot.Date.today(), this.onChange = null, this.onChanged = null, this.onSelect = null, this.j.updateMode = function(e3) {
            ...
            var a2;
            if ("string" == typeof e3) {
              if (a2 = document.getElementById(e3), !a2)
                throw "Element not found: " + e3;
            } else
              a2 = e3;
            var n2 = a2, o = {};
            ...
            i2.j.control = e3, e3.timeRangeSelectedHandling = "JavaScript", e3.onTimeRangeSelected = function() {
              var a2, n2, o;
              if (1 === e3.api)
                a2 = arguments[0], n2 = arguments[1], o = arguments[2];
              else {
                var r = arguments[0];
            ...
            if (e3.A)
              n2 = e3, a2 = n2.C;
            else if (a2 = e3.m ? e3 : this.z(e3), this.k === a2)
              return;
            if (i2.onSelect) {
              var o = {};
            ...
            for (var t3 = 0; t3 < this.f.length; t3++)
              if (this.f[t3].control === e3)
                return this.f[t3];
            return null;
          }, this.t = function() {
            for (var e3 = 0; e3 < this.f.length; e3++)
              this.f[e3].p();
          }, Object.defineProperty(this, "active", { get: function() {
            return i2.k;
          } }), this.events = {}, this.events.load = function(e3, t3, a2) {
            if (!i2.k || !i2.k.control)
            ...
            if (e2)
              for (var t3 in e2)
                if ("triggers" === t3) {
                  ...
                  "navigator" === t3 ? i2.addNavigator(e2.navigator) : i2[t3] = e2[t3];
          }, this.H();
          ...
          return this.ticks = e2, DayPilot.Date.Cache.DurationCtor["" + e2] ? DayPilot.Date.Cache.DurationCtor["" + e2] : (DayPilot.Date.Cache.DurationCtor["" + e2] = this, this.toString = function(e3) {
            if (!e3)
              return t2.days() + "." + t2.hours() + ":" + t2.minutes() + ":" + t2.seconds() + "." + t2.milliseconds();
            var i3 = t2.minutes();
            i3 = (i3 < 10 ? "0" : "") + i3;
            var a3 = e3;
        ...
        DayPilot.Date = function(t2, i2) {
          if (t2 instanceof DayPilot.Date)
            return t2;
          var a2;
          DayPilot.Util.isNullOrUndefined(t2) && (a2 = DayPilot.DateUtil.fromLocal().getTime(), t2 = a2);
          var n2 = DayPilot.Date.Cache.Ctor;
          if (n2[t2])
            return DayPilot.Stats.cacheHitsCtor += 1, n2[t2];
          var o = false;
          if ("string" == typeof t2)
            a2 = DayPilot.DateUtil.fromStringSortable(t2, i2).getTime(), o = true;
          ...
          var r = e(a2);
          return n2[r] ? n2[r] : (n2[r] = this, n2[a2] = this, o && r !== t2 && DayPilot.DateUtil.hasTzSpec(t2) && (n2[t2] = this), Object.defineProperty && !DayPilot.browser.ielt9 ? (Object.defineProperty(this, "ticks", { get: function() {
            return a2;
          ...
          if (null === e2)
            return false;
          if (e2 instanceof DayPilot.Date)
            return this === e2;
          ...
          var t2 = this;
          if (e2 instanceof DayPilot.Locale)
            e2 = e2.weekStarts;
            ...
            e2 = e2 || 0;
          for (var a2 = t2.dayOfWeek(); a2 !== e2; )
            t2 = t2.addDays(-1), a2 = t2.dayOfWeek();
        ...
        DayPilot.Date.today = function() {
          ...
          if (!a2 && !n2 && !o)
            throw "Invalid string format (use '2010-01-01' or '2010-01-01T00:00:00'): " + e2;
          if (DayPilot.Date.Cache.Parsing[e2] && !t2)
            return DayPilot.Stats.cacheHitsParsing += 1, DayPilot.Date.Cache.Parsing[e2];
          var r = e2.substring(0, 4), s = e2.substring(5, 7), l = e2.substring(8, 10), d = /* @__PURE__ */ new Date(0);
          if (d.setUTCFullYear(r, s - 1, l), a2)
            return DayPilot.Date.Cache.Parsing[e2] = d, d;
          var c = e2.substring(11, 13), u = e2.substring(14, 16), h = e2.substring(17, 19);
          if (d.setUTCHours(c), d.setUTCMinutes(u), d.setUTCSeconds(h), n2)
            return DayPilot.Date.Cache.Parsing[e2] = d, d;
          var f = e2[19], m = 0;
          if ("." === f) {
            ...
            m = DayPilot.DateUtil.getTzOffsetMinutes(e2.substring(19));
          ...
          if (DayPilot.Util.isNullOrUndefined(e2) || "" === e2)
            return 0;
          if ("Z" === e2)
            return 0;
          ...
          }(), e2 = new DayPilot.Date(e2), t2 = new DayPilot.Date(t2), e2.getTime() > t2.getTime())
            return null;
          for (var i2 = 0, a2 = e2.getDatePart(), n2 = t2.getDatePart(); a2 < n2; )
            a2 = a2.addDays(1), i2++;
          return i2;
          ...
          if (!(e2 && t2 && e2.getTime && t2.getTime))
        ...
        var n = function(e2, i2) {
          ...
          this.init = function() {
            ...
            for (var i3 = function(e3) {
              for (var t3 = 0; t3 < a2.length; t3++)
                if (a2[t3] && a2[t3].seq === e3)
                  return a2[t3];
              return null;
            ...
            if (DayPilot.Util.isNullOrUndefined(i3))
              return null;
            if (i3 > 12 || i3 < 1)
              return null;
        ...
        DayPilot.ColorUtil = {}, DayPilot.ColorUtil.hexToRgb = function(e2) {
          ...
          this.isEvent = true, this.temp = function() {
            ...
            for (var e3 = 0; e3 < o.length; e3++)
              n2[o[e3]] = a2.data[o[e3]];
            return n2.dirty = true, n2;
          }, this.copy = function() {
            for (var e3 = {}, t3 = 0; t3 < o.length; t3++)
              e3[o[t3]] = a2.data[o[t3]];
            return e3;
          }, this.commit = function() {
            if (n2.dirty) {
              for (var e3 = 0; e3 < o.length; e3++)
                a2.data[o[e3]] = n2[o[e3]];
              n2.dirty = false;
            }
          }, this.dirty = function() {
            return n2.dirty;
            ...
            if ("undefined" == typeof e3)
              return a2.data.tag;
            for (var i3 = a2.calendar.tagFields, n3 = -1, o2 = 0; o2 < i3.length; o2++)
              e3 === i3[o2] && (n3 = o2);
            if (n3 === -1)
            ...
            var t3 = {};
            if (t3.value = this.id(), t3.id = this.id(), t3.text = this.text(), t3.start = this.start(), t3.end = this.end(), t3.tag = {}, a2.calendar && a2.calendar.tagFields)
              for (var i3 = a2.calendar.tagFields, n3 = 0; n3 < i3.length; n3++)
                t3.tag[i3[n3]] = this.tag(i3[n3]);
            return t3;
          };
        };
      }
        ...
        switch (f && "object" == typeof f && "function" == typeof f.toJSON2 ? f = f.toJSON2(e2) : f && "object" == typeof f && "function" == typeof f.toJSON && !f.ignoreToJSON && (f = f.toJSON(e2)), "function" == typeof o && (f = o.call(r2, e2, f)), typeof f) {
          ...
          case "object":
            ...
            if (a += n, u = [], "number" == typeof f.length && !f.propertyIsEnumerable("length")) {
              for (c = f.length, s2 = 0; s2 < c; s2 += 1)
                u[s2] = i(s2, f) || "null";
              return d = 0 === u.length ? "[]" : a ? "[\n" + a + u.join(",\n" + a) + "\n" + h + "]" : "[" + u.join(",") + "]", a = h, d;
            }
            if (o && "object" == typeof o)
              for (c = o.length, s2 = 0; s2 < c; s2 += 1)
                l = o[s2], "string" == typeof l && (d = i(l, f), d && u.push(t(l) + (a ? ": " : ":") + d));
            else
              for (l in f)
                Object.hasOwnProperty.call(f, l) && (d = i(l, f), d && u.push(t(l) + (a ? ": " : ":") + d));
            return d = 0 === u.length ? "{}" : a ? "{\n" + a + u.join(",\n" + a) + "\n" + h + "}" : "{" + u.join(",") + "}", a = h, d;
        }
      }
      ...
      "function" != typeof DayPilot.JSON.stringify && (DayPilot.JSON.stringify = function(e2, t2, r2) {
        var s2;
        if (a = "", n = "", "number" == typeof r2)
          for (s2 = 0; s2 < r2; s2 += 1)
            n += " ";
        else
          "string" == typeof r2 && (n = r2);
        if (o = t2, t2 && "function" != typeof t2 && ("object" != typeof t2 || "number" != typeof t2.length))
    ...
    if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function() {
      ...
      if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
        ...
        t.selectedCells = [], t.topSelectedCell = null, t.bottomSelectedCell = null, t.selecting = false, t.column = null, t.firstSelected = null, t.firstMousePos = null, t.originalMouse = null, t.originalHeight = null, t.originalTop = null, t.resizing = null, t.globalHandlers = false, t.moving = null, t.register = function(e2) {
          ...
          for (var i = [], a = t.getColumn(e2), n = e2.parentNode, o = null; n && o !== t.firstSelected; )
            for (o = n.getElementsByTagName("td")[a], i.push(o), n = n.previousSibling; n && "TR" !== n.tagName; )
              n = n.previousSibling;
          return i;
        }, t.getCellsBelow = function(e2) {
          for (var i = [], a = t.getColumn(e2), n = e2.parentNode, o = null; n && o !== t.firstSelected; )
            for (o = n.getElementsByTagName("td")[a], i.push(o), n = n.nextSibling; n && "TR" !== n.tagName; )
              n = n.nextSibling;
          return i;
        }, t.getColumn = function(e2) {
          for (var t2 = 0; e2.previousSibling; )
            e2 = e2.previousSibling, "TD" === e2.tagName && t2++;
          return t2;
          ...
          var a = false;
          if (this instanceof t.Calendar && !this.M && (a = true, this.M = true), !a)
            throw "DayPilot.Calendar() is a constructor and must be called as 'var c = new DayPilot.Calendar(id);'";
          var n = this;
          this.uniqueID = null, this.isCalendar = true, this.v = "2023.4.504-lite", this.id = e2, this.clientName = e2, this.cache = {}, this.cache.pixels = {}, this.elements = {}, this.elements.events = [], this.elements.selection = [], this.nav = {}, this.afterRender = function() {
          ...
          }, this.O = navigator && navigator.userAgent && navigator.userAgent.indexOf("MSIE") !== -1, this.cleanSelection = this.clearSelection, this.P = function(e3, t2, i2) {
            var a2 = {};
            ...
            for (var i2 = e3.parentNode; i2 && "TD" !== i2.tagName; )
              i2 = i2.parentNode;
          ...
          this.T = function(e3, t2) {
            ...
            var e3 = 0;
            return e3 = "BusinessHoursNoScroll" === this.heightSpec ? this.la() : 24, 60 * e3 * 60 * 1e3;
          }, this.na = function() {
            ...
            var t2 = this.event;
            if (e3.stopPropagation && e3.stopPropagation(), !t2.client.rightClickEnabled())
              return false;
            var i2 = {};
            if (i2.e = t2, i2.preventDefault = function() {
              this.preventDefault.value = true;
            }, "function" == typeof n.onEventRightClick && (n.onEventRightClick(i2), i2.preventDefault.value))
              return false;
            ...
            if ("top" === a2) {
              var c = l.getDatePart(), u = Math.floor((i2 - o2) / n.cellHeight), h = 30 * u, f = 60 * h * 1e3, m = 60 * n.na() * 60 * 1e3;
              r = c.addTime(f + m), s = e3.end();
            } else if ("bottom" === a2) {
              var c = d.getDatePart(), u = Math.floor((i2 + t2 - o2) / n.cellHeight), h = 30 * u, f = 60 * h * 1e3, m = 60 * n.na() * 60 * 1e3;
              r = l, s = c.addTime(f + m);
            }
            if (n.oa()) {
              var p = {};
            ...
            var u = l.getTime() - (c.getTime() + 3600 * l.getUTCHours() * 1e3 + 30 * Math.floor(l.getUTCMinutes() / 30) * 60 * 1e3), h = d.getTime() - l.getTime(), f = this.ta[t2], m = f.id, p = f.start.getTime(), v = /* @__PURE__ */ new Date();
            v.setTime(p + s + u);
            ...
            if (e3 = new DayPilot.Date(e3), t2 = new DayPilot.Date(t2), this.oa()) {
              var a2 = {};
            ...
            if (!t.selecting && "Disabled" !== n.timeRangeSelectedHandling) {
              var i2 = e3.which;
              if (1 === i2 || 0 === i2)
                return t.firstMousePos = DayPilot.mc(e3), t.selecting = {}, t.selecting.calendar = n, t.selectedCells && (n.clearSelection(), t.selectedCells = []), t.column = t.getColumn(this), t.selectedCells.push(this), t.firstSelected = this, t.topSelectedCell = this, t.bottomSelectedCell = this, n.va(), false;
            }
          }, this.va = function() {
            this.getSelection();
            !function() {
              var e3 = t.topSelectedCell, i2 = t.bottomSelectedCell, a2 = function() {
                if (e3.data)
                  return e3.data.x;
                for (var t2 = e3.parentNode.cells, i3 = 0; i3 < t2.length; i3++)
                  if (t2[i3] === e3)
                    return i3;
                return -1;
              }(), o2 = n.ta[a2];
            ...
            if ("undefined" != typeof t && t.selecting) {
              ...
              t.getColumn(this) === t.column && (n.clearSelection(), i2.y < t.firstMousePos.y ? (t.selectedCells = t.getCellsBelow(this), t.topSelectedCell = t.selectedCells[0], t.bottomSelectedCell = t.firstSelected) : (t.selectedCells = t.getCellsAbove(this), t.topSelectedCell = t.firstSelected, t.bottomSelectedCell = t.selectedCells[0]), n.va());
            }
            ...
            for (var t2 = 0, i2 = n.nav.events.rows[0].cells, a2 = 0; a2 < i2.length; a2++) {
              if (t2 += i2[a2].offsetWidth, e3 < t2)
                return a2;
            }
            return null;
          }, this.ya = {}, this.ya.getCellCoords = function() {
            var e3 = {};
            if (e3.x = 0, e3.y = 0, !n.coords)
              return null;
            e3.x = n.xa(n.coords.x);
            ...
            var a2 = function(e4) {
              ...
              if (DayPilot.isArray(i3)) {
                ...
                if (s.preventDefault = function() {
                  this.preventDefault.value = true;
                }, s.data = i3, "function" == typeof t2 && t2(s), s.preventDefault.value)
                  return;
                n.columns.list = i3, n.za && n.update();
              }
            };
            ...
            var e3;
            e3 = "Resources" !== n.viewType ? this.Aa() : n.columns.list, this.ta = [];
            for (var t2 = 0; t2 < e3.length; t2++) {
              var i2 = this.Ba(e3[t2]);
              this.ta.push(i2);
            }
          }, this.Ba = function(e3) {
            var t2 = {};
            return t2.name = e3.name, t2.html = e3.html, t2.id = e3.id, t2.toolTip = e3.toolTip, t2.data = e3, e3.start ? t2.start = new DayPilot.Date(e3.start) : t2.start = new DayPilot.Date(n.startDate), t2.putIntoBlock = function(e4) {
              for (var t3 = 0; t3 < this.blocks.length; t3++) {
                ...
                if (i2.overlapsWith(e4.part.top, e4.part.height))
                  return i2.events.push(e4), i2.min = Math.min(i2.min, e4.part.top), i2.max = Math.max(i2.max, e4.part.top + e4.part.height), t3;
              }
              var i2 = [];
              return i2.lines = [], i2.events = [], i2.overlapsWith = function(e5, t4) {
                ...
                for (var t4 = 0; t4 < this.lines.length; t4++) {
                  ...
                  if (i3.isFree(e5.part.top, e5.part.height))
                    return i3.push(e5), t4;
                }
                var i3 = [];
                return i3.isFree = function(e6, t5) {
                  for (var i4 = e6 + t5 - 1, a2 = this.length, n2 = 0; n2 < a2; n2++) {
                    var o2 = this[n2];
                    if (!(i4 < o2.part.top || e6 > o2.part.top + o2.part.height - 1))
                      return false;
                  }
                  return true;
              ...
              for (var t3 = 0; t3 < this.lines.length; t3++) {
                ...
                if (i2.isFree(e4.part.top, e4.part.height))
                  return i2.push(e4), t3;
              }
              var i2 = [];
              return i2.isFree = function(e5, t4) {
                for (var i3 = e5 + t4 - 1, a2 = this.length, n2 = 0; n2 < a2; n2++) {
                  var o2 = this[n2];
                  if (!(i3 < o2.part.top || e5 > o2.part.top + o2.part.height - 1))
                    return false;
                }
                return true;
            ...
            switch (this.viewType) {
              case "Day":
                ...
                break;
              case "Week":
                i2 = 7, t2 = t2.firstDayOfWeek(o.locale().weekStarts);
                break;
              case "WorkWeek":
            ...
            for (var a2 = 0; a2 < i2; a2++) {
              ...
              s.start = t2.addDays(a2), s.name = s.start.toString(r, o.locale()), e3.push(s);
            }
            return e3;
            ...
            var t2 = this.ta.length - 1;
            return this.ta[t2].start.addDays(1);
          }, this.J = function(e3) {
            var t2 = this.theme || this.cssClassPrefix;
            return t2 ? t2 + e3 : "";
          }, this.V = function() {
            if (this.elements.events)
              for (var e3 = 0; e3 < this.elements.events.length; e3++) {
            ...
            if (DayPilot.Areas.attach(o2, e3, { "areas": f }), a2.rows[0].cells[e3.part.dayIndex]) {
              a2.rows[0].cells[e3.part.dayIndex].firstChild.appendChild(o2), n.Da(o2);
            }
            ...
            for (var t2 = e3 && e3.childNodes ? e3.childNodes.length : 0, i2 = 0; i2 < t2; i2++)
              try {
                var a2 = e3.childNodes[i2];
                1 === a2.nodeType && (a2.unselectable = "on", this.Da(a2));
              } catch (e4) {
              }
          }, this.ia = function() {
            for (var e3 = 0; e3 < this.ta.length; e3++) {
              var t2 = this.ta[e3];
              if (t2.blocks)
                for (var i2 = 0; i2 < t2.blocks.length; i2++)
                  for (var a2 = t2.blocks[i2], n2 = 0; n2 < a2.lines.length; n2++)
                    for (var o2 = a2.lines[n2], r = 0; r < o2.length; r++) {
                      var s = o2[r];
            ...
            i2 = a2.insertCell(-1), i2.valign = "top", i2.style.padding = "0px", i2.style.border = "0px none", this.nav.hourTable = this.Ja(), i2.appendChild(this.nav.hourTable), i2 = a2.insertCell(-1), i2.valign = "top", i2.width = "100%", i2.style.padding = "0px", i2.style.border = "0px none";
            var n2 = document.createElement("div");
            return n2.style.position = "relative", i2.appendChild(n2), n2.appendChild(this.Ka()), n2.appendChild(this.La()), e3.appendChild(t2), this.nav.zoom = e3, e3;
          }, this.Ka = function() {
            ...
            for (var t2 = this.ta, i2 = t2.length, a2 = e3.insertRow(-1), o2 = 0; o2 < i2; o2++) {
            ...
            for (var t2 = n.ja(), i2 = 0; i2 < t2; i2++)
              this.Ma(e3, i2);
            return e3;
          }, this.Ma = function(e3, t2) {
            ...
            d.unselectable = "on";
            var c = this.startDate.addHours(t2).addHours(n.na()), u = c.getHours(), h = u < 12, f = o.timeFormat();
            ...
            for (var t2 = 0; t2 < e3.rows.length; t2++)
              for (var i2 = e3.rows[t2], a2 = 0; a2 < i2.cells.length; a2++) {
                var n2 = i2.cells[a2];
            ...
            var e3 = this.nav.main, i2 = 18e5, a2 = this.ma(), o2 = n.ta;
            for (e3 && this.W(); e3 && e3.rows && e3.rows.length > 0; )
              this.fasterDispose || DayPilot.pu(e3.rows[0]), e3.deleteRow(0);
            this.tableCreated = true;
            for (var r = o2.length, s = this.nav.events; s && s.rows && s.rows.length > 0; )
            ...
            for (var f = 0; f < a2; f++) {
              ...
              for (var d = 0; d < r; d++) {
                ...
                c.start = m.start.addTime(f * i2), c.end = c.start.addTime(i2), c.resource = m.id, c.onmousedown = this.ua, c.onmouseup = function() {
                  return false;
                }, c.onclick = function() {
                  return false;
            ...
            e3.root = this, n.nav.scrollable.onmousemove = function(e4) {
              ...
              if (t.resizing) {
                ...
                c2 < r2 && (c2 = r2);
                var m2 = n.nav.events, d2 = n.nav.main.clientHeight, p2 = parseInt(t.movingShadow.style.height);
                ...
                var v = m2.clientWidth / m2.rows[0].cells.length, y = Math.floor((n.coords.x - 45) / v);
                y < 0 && (y = 0), y < m2.rows[0].cells.length && y >= 0 && t.movingShadow.column !== y && (t.movingShadow.column = y, t.moveShadow(m2.rows[0].cells[y]));
              } else if (t.selecting) {
                var a3 = DayPilot.mc(e4), g = n.ya.getCellCoords(), b = t.column, D = n.nav.main.rows[g.y].cells[b];
                a3.y < t.firstMousePos.y ? (t.selectedCells = t.getCellsBelow(D), t.topSelectedCell = t.selectedCells[0], t.bottomSelectedCell = t.firstSelected) : (t.selectedCells = t.getCellsAbove(D), t.topSelectedCell = t.firstSelected, t.bottomSelectedCell = t.selectedCells[0]), n.va();
              }
            }, n.nav.scrollable.style.display = "";
          }, this.Pa = function(e3, t2) {
            ...
            function t2(t3) {
              ...
              r2.data = o3, r2.style.overflow = "hidden", r2.style.padding = "0px", r2.style.border = "0px none", r2.style.height = n.headerHeight + "px", r2.onclick = n.Ra;
              ...
              l.firstChild.innerHTML = n.Ia(o3.name, o3.html);
            }
            for (var i2 = e3 ? this.nav.header.insertRow(-1) : this.nav.header.rows[0], a2 = this.ta, o2 = a2.length, r = 0; r < o2; r++)
              t2(r);
          }, this.Ra = function(e3) {
            if ("Disabled" !== n.headerClickHandling) {
              var t2 = this.data, i2 = n.Sa(t2), a2 = {};
            ...
            var e3 = this.nav.header, t2 = true, i2 = this.ta;
            for (i2.length; this.headerCreated && e3 && e3.rows && e3.rows.length > 0; )
              this.fasterDispose || DayPilot.pu(e3.rows[0]), e3.deleteRow(0);
            ...
            var t2 = "undefined" != typeof this.Wa.scrollpos ? this.Wa.scrollpos : this.initScrollPos;
            ...
            var t2 = null;
            if (e3 instanceof DayPilot.Event)
              t2 = e3.data;
            else {
              if ("object" != typeof e3)
            ...
            n.events.list || (n.events.list = []), n.events.list.push(t2), n.Za({ "eventsOnly": true }), n.qa.notify();
            ...
            for (var i2 = 0; i2 < n.events.list.length; i2++) {
              ...
              if (o2.id === e3)
                return new DayPilot.Event(o2, n);
            }
            return null;
            ...
            n.Za({ "eventsOnly": true }), n.qa.notify();
            ...
            n.events.list.splice(a2, 1), n.Za({ "eventsOnly": true }), n.qa.notify();
            ...
            var a2 = function(e4) {
              ...
              if (DayPilot.isArray(i3)) {
                ...
                if (s2.preventDefault = function() {
                  this.preventDefault.value = true;
                }, s2.data = i3, "function" == typeof t2 && t2(s2), s2.preventDefault.value)
                  return;
                n.events.list = i3, n.za && n.Za({ "eventsOnly": true });
              }
            };
            if (n.eventsLoadMethod && "POST" === n.eventsLoadMethod.toUpperCase())
              DayPilot.Http.ajax({ "method": "POST", "data": { "start": n.visibleStart().toString(), "end": n.visibleEnd().toString() }, "url": e3, "success": o2, "error": a2 });
            else {
            ...
            if (this.za) {
              ...
              n.ab(), n.V(), n.nav.top.style.cursor = "auto", t2 && (n.ba(), n.ea(), n.fa(), n.ga(), n.ha(), n.Na(), n.$a(), n.bb()), n.ca(), n.da(), n.s(), n.ia(), n.clearSelection(), this.visible ? this.show() : this.hide();
            }
          }, this.cb = null, this._a = function(e3) {
            if (e3) {
            ...
            if (this.id && this.id.tagName)
              ...
              if (this.nav.top = document.getElementById(this.id), !this.nav.top)
                throw "DayPilot.Calendar: The placeholder element not found: '" + e2 + "'.";
            }
          }, this.fb = {}, this.fb.events = [], this.gb = function(e3) {
            var t2 = this.fb.events, i2 = this.events.list[e3], a2 = {};
            for (var o2 in i2)
              a2[o2] = i2[o2];
            ...
            if (n.fb.events = [], e3) {
              if (!DayPilot.isArray(e3))
                throw new DayPilot.Exception("DayPilot.Calendar.events.list expects an array object. You supplied: " + typeof e3);
              ...
              if ("function" == typeof this.onBeforeEventRender)
                for (var o2 = 0; o2 < t2; o2++)
                  this.gb(o2);
              for (var o2 = 0; o2 < this.ta.length; o2++) {
                var l = {};
                l.minEnd = 1e6, l.maxStart = -1, this.scrollLabels.push(l);
                var d = this.ta[o2];
                d.events = [], d.lines = [], d.blocks = [];
                for (var c = new DayPilot.Date(d.start), u = c.getTime(), h = c.addTime(i2), f = h.getTime(), m = 0; m < t2; m++)
                  if (!a2[m]) {
                    ...
                    if (!(g < y)) {
                      ...
                      if ("Resources" === n.viewType && (b = b && d.id === r.resource), b) {
                        ...
                        p > l.maxStart && (l.maxStart = p), v < l.minEnd && (l.minEnd = v), p < this.minStart && (this.minStart = p), v > this.maxEnd && (this.maxEnd = v), d.events.push(D), "function" == typeof this.onBeforeEventRender && (D.cache = this.fb.events[m]), D.part.start.getTime() === y && D.part.end.getTime() === g && (a2[m] = true);
                      }
                    }
                  }
              }
          ...
          }, this.hb = function(e3, t2) {
            if (!(e3 && t2 && e3.start && t2.start))
              return 0;
            ...
            0 === s && (d = l);
            var c = {};
            return c.cut = false, c.top = this.ib(r), c.boxTop = this.ib(l), c.boxBottom = this.ib(d), this.cache.pixels[a2 + "_" + i2] = c, c;
          }, this.ib = function(e3) {
            ...
            var e3 = 0;
            "number" == typeof n.Wa.scrollHour ? e3 = 2 * n.cellHeight * n.Wa.scrollHour : "Auto" === n.initScrollPos && (e3 = "BusinessHours" === this.heightSpec ? 2 * this.cellHeight * this.businessBeginsHour : 0), n.nav.scroll.scrollTop = e3;
          }, this.jb = function() {
            ...
            this.ab(), this.ba(), this.Ea(), this.ea(), this.fa(), this.Xa(), this.Ua(), this.Ya(), t.register(this), this.lb(), this.R("Init");
          }, this.Wa = {}, this.mb = function() {
            this.Wa.themes = [], this.Wa.themes.push(this.theme || this.cssClassPrefix);
          }, this.nb = function() {
            for (var e3 = this.Wa.themes, t2 = 0; t2 < e3.length; t2++) {
              var i2 = e3[t2];
            ...
            e3() || (n.U = setInterval(function() {
              e3() && (n.Ua(), n.Xa(), clearInterval(n.U));
            }, 100));
          }, this.Ia = function(e3, t2) {
          ...
          }, this.internal = {}, this.internal.loadOptions = n._a, this.internal.xssTextHtml = n.Ia, this.init = function() {
            this.eb();
            var e3 = this.jb();
            return this.mb(), e3 ? void this.kb() : (this.ab(), this.ba(), this.ca(), this.Ea(), this.ea(), this.fa(), this.s(), this.Xa(), this.Ua(), this.Ya(), t.register(this), this.events && (this.da(), this.ia()), this.ob(), this.pb(), this.lb(), this.za = true, this);
          }, this.Init = this.init, this._a(i);
    ...
    if (function() {
      "undefined" != typeof DayPilot.DatePicker && DayPilot.DatePicker.close || (DayPilot.DatePicker = function(e) {
        ...
        this.onShow = null, this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.prepare = function() {
          if (this.locale = "en-us", this.target = null, this.targetAlignment = "left", this.resetTarget = true, this.pattern = this._.locale().datePattern, this.theme = "navigator_default", this.patterns = [], this.zIndex = null, e)
            for (var t2 in e)
              this[t2] = e[t2];
        }, this.init = function() {
          this.date = new DayPilot.Date(this.date);
          var e2 = this.sb();
          this.resetTarget && !e2 ? this.tb(this.date) : this.resetTarget || (i.date = e2);
          var t2 = this.B();
          return t2 && t2.addEventListener("input", function() {
            i.date = i.sb(), i.date && i.navigator.select(i.date, { dontNotify: true });
          }), document.addEventListener("mousedown", function() {
            i.close();
          }), this;
        }, this.close = function() {
          this.rb && (this.rb = false, this.navigator && this.navigator.dispose(), this.div.innerHTML = "", this.div && this.div.parentNode === document.body && document.body.removeChild(this.div));
        }, this.setDate = function(e2) {
          this.date = new DayPilot.Date(e2), this.tb(this.date);
        }, this.sb = function() {
          var e2 = this.B();
          if (!e2)
            return this.date;
          var t2 = null;
          if (t2 = "INPUT" === e2.tagName ? e2.value : e2.innerText, !t2)
            return null;
          ...
          if (!this.rb) {
            ...
            a.api = 2, a.cssOnly = true, a.theme = i.theme, a.weekStarts = "Auto", a.locale = i.locale, a.onTimeRangeSelected = function(e3) {
              i.date = e3.start;
              var t2 = e3.start.addTime(a.ub), n2 = t2.toString(i.pattern, i.locale), e3 = {};
              e3.start = t2, e3.date = t2, e3.preventDefault = function() {
                this.preventDefault.value = true;
              }, "function" == typeof i.onTimeRangeSelect && (i.onTimeRangeSelect(e3), e3.preventDefault.value) || (i.tb(n2), i.close(), "function" == typeof i.onTimeRangeSelected && i.onTimeRangeSelected(e3));
            }, this.navigator = a;
            ...
            this.rb = true, this.onShow && this.onShow();
          }
    ...
    if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function(DayPilot2) {
      ...
      if ("undefined" == typeof DayPilot2.Menu || !DayPilot2.Menu.def) {
        ...
        t.mouse = null, t.menu = null, t.handlersRegistered = false, t.hideTimeout = null, t.waitingSubmenu = null, DayPilot2.Menu = function(i) {
          var a = this, n = null;
          this.v = "2023.4.504-lite", this.zIndex = 120, this.cssClassPrefix = "menu_default", this.cssOnly = true, this.menuTitle = null, this.showMenuTitle = false, this.hideOnMouseOut = false, this.hideAfter = 200, this.theme = null, this.onShow = null, this.vb = function() {
          }, i && DayPilot2.isArray(i) && (this.items = i), this.toJSON = function() {
            return null;
          }, this.show = function(i2, o2) {
            o2 = o2 || {};
            var r2 = null;
            if (i2 ? "string" == typeof i2.id || "number" == typeof i2.id ? r2 = i2.id : "function" == typeof i2.id ? r2 = i2.id() : "function" == typeof i2.value && (r2 = i2.value()) : r2 = null, "undefined" != typeof DayPilot2.Bubble && DayPilot2.Bubble.hideActive(), o2.submenu || t.menuClean(), this.vb.submenu = null, null !== t.mouse) {
              ...
              if (i2 && i2.isRow && i2.$.row.task ? (s = new DayPilot2.Task(i2.$.row.task, i2.calendar), s.menuType = "resource") : s = i2 && i2.isEvent && i2.data.task ? new DayPilot2.Task(i2, i2.calendar) : i2, "function" == typeof a.onShow) {
                ...
                }, a.onShow(l), l.preventDefault.value)
                  return;
              }
              var d = document.createElement("div");
              if (d.style.position = "absolute", d.style.top = "0px", d.style.left = "0px", d.style.display = "none", d.style.overflow = "hidden", d.style.zIndex = this.zIndex + 1, d.className = this.wb("main"), d.onclick = function(e2) {
              ...
              for (var u = 0; u < this.items.length; u++) {
                ...
                if (DayPilot2.Util.addClass(f, this.wb("item")), h.items && (DayPilot2.Util.addClass(f, this.wb("item_haschildren")), DayPilot2.Util.addClass(d, this.wb("withchildren"))), "undefined" != typeof h && !h.hidden) {
                  if ("-" === h.text) {
                    ...
                    if (p.style.position = "relative", p.style.display = "block", h.cssClass && DayPilot2.Util.addClass(p, h.cssClass), h.disabled)
                      DayPilot2.Util.addClass(p, a.wb("item_disabled"));
                    else {
                        ...
                        p.item = h, p.onclick = /* @__PURE__ */ function(e2, t2) {
                          return function(i3) {
                            if ("function" == typeof e2.onClick) {
                              ...
                              }, e2.onClick(a2), a2.preventDefault.value)
                                return;
                            }
                        ...
                        var v = function(e2, i3) {
                          return function(a2) {
                            ...
                            if ("function" == typeof e2.onClick) {
                              ...
                              }, e2.onClick(o3), o3.preventDefault.value)
                                return void n2();
                            }
                      ...
                      if (h.items && !h.disabled) {
                        var y = function(e2, t2) {
                          return function(i3) {
                            i3.preventDefault(), i3.stopPropagation(), a.xb(e2, t2);
                          };
                        };
                        p.ontouchend = y(h, p);
                      }
                      if (h.onclick)
                        ...
                        p.href = h.href.replace(/\x7B0\x7D/gim, r2), h.target && p.setAttribute("target", h.target);
                      else if (h.command) {
                        var y = function(e2, t2) {
                          return function(i3) {
                            ...
                            if (a2 instanceof DayPilot2.Link)
                              return void o3.internal.linkMenuClick(n2.command, a2, n2.action);
                            if (a2 instanceof DayPilot2.Selection)
                              return void o3.internal.timeRangeMenuClick(n2.command, a2, n2.action);
                            if (a2 instanceof DayPilot2.Event)
                              return void o3.internal.eventMenuClick(n2.command, a2, n2.action);
                            if (a2 instanceof DayPilot2.Selection)
                              return void o3.internal.timeRangeMenuClick(n2.command, a2, n2.action);
                            if (a2 instanceof DayPilot2.Task)
                              return void ("resource" === a2.menuType ? o3.internal.resourceHeaderMenuClick(n2.command, t2.menuSource, n2.action) : o3.internal.eventMenuClick(n2.command, t2.menuSource, n2.action));
                            switch (a2.menuType) {
                              case "resource":
                    ...
                    if (g.className = a.wb("item_text"), g.innerHTML = DayPilot2.Util.escapeTextHtml(h.text, h.html), p.appendChild(g), h.image) {
                    ...
                    var k = function(e2, i3) {
                      return function() {
                        ...
                        e2.disabled || (t.waitingSubmenu = {}, t.waitingSubmenu.parent = n2, t.waitingSubmenu.timeout = setTimeout(function() {
                          t.waitingSubmenu = null, a.xb(n2, i3);
                        }, 300));
                      };
                    };
              ...
              d.onclick = S, d.ontouchend = S, d.onmousedown = function(e2) {
                ...
                return false;
              }, document.body.appendChild(d), a.vb.visible = true, a.vb.source = i2, d.style.display = "";
              var M = d.offsetHeight, T = d.offsetWidth;
              d.style.display = "none";
              var A = document.documentElement.clientHeight, E = window.innerWidth, H = "number" == typeof o2.windowMargin ? o2.windowMargin : 5;
              if (function() {
                var e2 = o2.initiator;
                if (e2) {
                ...
                if (i3 - a2 > A - M && 0 !== A) {
                  ...
                  d.style.top = i3 + "px";
                if ("right" === o2.align && (e2 -= T), e2 - n2 > E - T && 0 !== E) {
                  var s2 = e2 - n2 - (E - T) + H;
                  d.style.left = e2 - s2 + "px";
                } else
                  d.style.left = e2 + "px";
              }(), o2.parentLink) {
                var N = o2.parentLink, I = parseInt(new DayPilot2.StyleReader(d).get("border-top-width")), z = DayPilot2.abs(o2.parentLink.parentNode), O = z.x + N.offsetWidth, U = z.y - I;
              ...
              d.style.display = "", this.addShadow(d), this.vb.div = d, o2.submenu || (DayPilot2.Menu.active = this);
            }
          }, this.xb = function(e2, t2) {
            var i2 = e2, n2 = t2.source;
            if ((!a.vb.submenu || a.vb.submenu.item !== e2) && (a.vb.submenu && a.vb.submenu.item !== e2 && (DayPilot2.Util.removeClass(a.vb.submenu.link.parentNode, a.wb("item_haschildren_active")), a.vb.submenu.menu.hide(), a.vb.submenu = null), e2.items)) {
              var o2 = a.cloneOptions();
              o2.items = e2.items, a.vb.submenu = {}, a.vb.submenu.menu = new DayPilot2.Menu(o2), a.vb.submenu.menu.yb = a, a.vb.submenu.menu.show(n2, { "submenu": true, "parentLink": t2, "parentItem": i2 }), a.vb.submenu.item = e2, a.vb.submenu.link = t2, DayPilot2.Util.addClass(t2.parentNode, a.wb("item_haschildren_active"));
            }
          }, this.wb = function(e2) {
            ...
            e2 = e2 || {}, this.vb.submenu && this.vb.submenu.menu.hide();
            var i2 = t.waitingSubmenu;
            if (i2 && (t.waitingSubmenu = null, clearTimeout(i2.timeout)), this.removeShadow(), this.vb.div && this.vb.div.parentNode === document.body && document.body.removeChild(this.vb.div), n && (DayPilot2.de(n), n = null), a.vb.visible = false, a.vb.source = null, a.yb && e2.hideParent && a.yb.hide(e2), DayPilot2.Menu.active === a && (DayPilot2.Menu.active = null), "function" == typeof this.onHide) {
              var o2 = {};
              this.onHide(o2);
            }
          ...
          var i = this;
          t2 = t2 || {}, this.items = [], this.theme = "menubar_default", this.windowMargin = 0, this.nav = {}, this.elements = {}, this.elements.items = DayPilot2.list(), this.k = null, this.za = false;
          for (var a in t2)
            this[a] = t2[a];
          this.zb = function(e3) {
            ...
            var t3 = this.nav.top;
            t3.className = this.zb("main"), DayPilot2.list(i.items).forEach(function(e3) {
              var a2 = document.createElement("span");
              a2.innerHTML = DayPilot2.Util.escapeTextHtml(e3.text, e3.html), a2.className = i.zb("item"), e3.cssClass && a2.classList.add(e3.cssClass), a2.data = e3, a2.onclick = function(t4) {
                if (i.active && i.active.item === e3)
                  i.Ab();
                else if (e3.children)
                  return void i.Bb(a2);
                ...
                i.active && i.active.item !== e3 && i.Bb(a2);
              }, t3.appendChild(a2), i.elements.items.push(a2);
            });
          }, this.Ab = function() {
            var e3 = i.zb("item_active");
            ...
            return this.s(), this.za = true, this;
          }, this.dispose = function() {
            this.za && (this.nav.top.innerHTML = "", this.elements.items = []);
          };
        }, DayPilot2.MenuBar.deactivate = function() {
          DayPilot2.MenuBar.active && (DayPilot2.MenuBar.active.Ab(), DayPilot2.MenuBar.active = null);
          ...
          if (e2 = e2 || {}, e2.calendar) {
            ...
            t.menuClean();
        }, t.handlersRegistered || (DayPilot2.re(document, "mousemove", t.mouseMove), DayPilot2.re(document, "mousedown", t.mouseDown), DayPilot2.re(document, "touchmove", t.touchMove), DayPilot2.re(document, "touchstart", t.touchStart), DayPilot2.re(document, "touchend", t.touchEnd), t.handlersRegistered = true), DayPilot2.Menu.def = {};
      }
      ...
      function e(t2, i2, a2) {
        var n2 = i2.indexOf(".");
        if (n2 === -1)
          return void ("__proto__" !== i2 && "constructor" !== i2 && (t2[i2] = a2));
      ...
      if (!DayPilot2.ModalStatic) {
        DayPilot2.ModalStatic = {}, DayPilot2.ModalStatic.list = [], DayPilot2.ModalStatic.hide = function() {
          ...
          for (var t2 = DayPilot2.ModalStatic.list, i2 = 0; i2 < t2.length; i2++)
            if (t2[i2] === e2)
              return void t2.splice(i2, 1);
        ...
        var i = function() {
          ...
          return i2.rules = [], i2.commit = function() {
            ...
            if (t2)
              return void this.rules.push(i3 + "{" + a2 + "}");
            if (e2.sheet.insertRule)
              "undefined" == typeof n2 && (n2 = e2.sheet.cssRules.length), e2.sheet.insertRule(i3 + "{" + a2 + "}", n2);
            else {
              if (!e2.sheet.addRule)
                throw "No CSS registration method found";
              e2.sheet.addRule(i3, a2, n2);
            }
          }, i2;
        ...
        n.add(".modal_default_main", "border: 10px solid #ccc; max-width: 90%;"), n.add(".modal_default_main:focus", "outline: none;"), n.add(".modal_default_content", "padding: 10px 0px;"), n.add(".modal_default_inner", "padding: 20px;"), n.add(".modal_default_input", "padding: 10px 0px;"), n.add(".modal_default_buttons", "margin-top: 10px;"), n.add(".modal_default_buttons", "padding: 10px 0px;"), n.add(".modal_default_form_item", "padding: 10px 0px; position: relative;"), n.add(".modal_default_form_item_level1", "border-left: 2px solid #ccc; margin-left: 10px; padding-left: 20px;"), n.add(".modal_default_form_item.modal_default_form_title", "font-size: 1.5rem; font-weight: bold;"), n.add(".modal_default_form_item input[type=text]", "width: 100%; box-sizing: border-box;"), n.add(".modal_default_form_item textarea", "width: 100%; height: 200px; box-sizing: border-box;"), n.add(".modal_default_form_item input[type=select]", "width: 100%; box-sizing: border-box;"), n.add(".modal_default_form_item label", "display: block;"), n.add(".modal_default_form_item select", "width: 100%; box-sizing: border-box;"), n.add(".modal_default_form_item_label", "margin: 2px 0px;"), n.add(".modal_default_form_item_image img", "max-width: 100%; height: auto;"), n.add(".modal_default_form_item_invalid", ""), n.add(".modal_default_form_item_invalid_message", "position: absolute; right: 0px; top: 9px; background-color: red; color: #ffffff; padding: 2px; border-radius: 2px;"), n.add(".modal_default_background", "opacity: 0.5; background-color: #000;"), n.add(".modal_default_ok", "padding: 3px; width: 80px;"), n.add(".modal_default_cancel", "padding: 3px; width: 80px;"), n.add(".modal_default_form_item_date", "position: relative;"), n.add(".modal_default_form_item_date:after", "content: ''; position: absolute; right: 7px; top: 50%; margin-top: 3px; width: 10px; height: 15px; background-image:url(data:image/svg+xml;base64,)"), navigator.userAgent.indexOf("Edge") !== -1 && n.add(".modal_default_form_item_date input::-ms-clear", "display: none;"), n.add(".modal_default_form_item_scrollable_scroll", "width: 100%; height: 200px; box-sizing: border-box; border: 1px solid #ccc; overflow-y: auto;"), n.add(".modal_default_form_item_scrollable_scroll_content", "padding: 5px;"), n.add(".modal_default_form_item_searchable", "position: relative;"), n.add(".modal_default_form_item_searchable_icon", ""), n.add(".modal_default_form_item_searchable_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + a + ");"), n.add(".modal_default_form_item_searchable_list", "box-sizing: border-box; border: 1px solid #999; max-height: 150px; overflow-y: auto;"), n.add(".modal_default_form_item_searchable_list_item", "background: white; padding: 2px; cursor: default;"), n.add(".modal_default_form_item_searchable_list_item_highlight", "background: #ccc;"), n.add(".modal_default_form_item_time", "position: relative;"), n.add(".modal_default_form_item_time_icon", ""), n.add(".modal_default_form_item_time_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + a + ");"), n.add(".modal_default_form_item_time_list", "box-sizing: border-box; border: 1px solid #999; max-height: 150px; overflow-y: auto;"), n.add(".modal_default_form_item_time_list_item", "background: white; padding: 2px; cursor: default;"), n.add(".modal_default_form_item_time_list_item_highlight", "background: #ccc;"), n.add(".modal_default_form_item_datetime_parent", "display: flex;"), n.add(".modal_default_form_item_datetime .modal_default_form_item_time_main", "margin-left: 5px;"), n.add(".modal_default_form_item_datetime input[type='text'].modal_default_input_date ", ""), n.add(".modal_default_form_item_tabular_main", "margin-top: 10px;"), n.add(".modal_default_form_item_tabular_table", "display: table; width: 100%; xbackground-color: #fff; border-collapse: collapse;"), n.add(".modal_default_form_item_tabular_tbody", "display: table-row-group;"), n.add(".modal_default_form_item_tabular_row", "display: table-row;"), n.add(".modal_default_form_item_tabular_row.modal_default_form_item_tabular_header", ""), n.add(".modal_default_form_item_tabular_cell.modal_default_form_item_tabular_rowaction", "padding: 0px; width: 23px;"), n.add(".modal_default_form_item_tabular_cell", "display: table-cell; border: 0px; padding: 2px 2px 2px 0px; cursor: default; vertical-align: bottom;"), n.add(".modal_default_form_item_tabular_header .modal_default_form_item_tabular_cell", "padding-left: 0px; padding-bottom: 0px;"), n.add(".modal_default_form_item_tabular_table input[type=text], .modal_default_form_item_tabular_table input[type=number]", "width:100%; box-sizing: border-box;"), n.add(".modal_default_form_item_tabular_table select", "width:100%; height:100%; box-sizing: border-box;"), n.add(".modal_default_form_item_tabular_plus", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"), n.add(".modal_default_form_item_tabular_plus:after", `content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url("data:image/svg+xml;base64,")`), n.add(".modal_default_form_item_tabular_delete", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"), n.add(".modal_default_form_item_tabular_delete:after", `content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url("data:image/svg+xml;base64,")`), n.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_plus", "display: none;"), n.add(".modal_default_form_item_tabular_plus_max.modal_default_form_item_tabular_plus", "display: none;"), n.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_delete", "visibility: hidden;"), n.add(".modal_default_form_item_tabular_empty", "height: 1px; margin: 5px 23px 5px 0px; background-color: #ccc;"), n.add(".modal_default_form_item_tabular_spacer .modal_default_form_item_tabular_cell", "padding: 0px;"), n.add(".modal_min_main", "border: 1px solid #ccc; max-width: 90%;"), n.add(".modal_min_background", "opacity: 0.5; background-color: #000;"), n.add(".modal_min_ok", "padding: 3px 10px;"), n.add(".modal_min_cancel", "padding: 3px 10px;"), n.add(".navigator_modal_main", "border-left: 1px solid #c0c0c0;border-right: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;background-color: white;color: #000000; box-sizing: content-box;"), n.add(".navigator_modal_main *, .navigator_modal_main *:before, .navigator_modal_main *:after", "box-sizing: content-box;"), n.add(".navigator_modal_month", "font-size: 11px;"), n.add(".navigator_modal_day", "color: black;"), n.add(".navigator_modal_weekend", "background-color: #f0f0f0;"), n.add(".navigator_modal_dayheader", "color: black;"), n.add(".navigator_modal_line", "border-bottom: 1px solid #c0c0c0;"), n.add(".navigator_modal_dayother", "color: gray;"), n.add(".navigator_modal_todaybox", "border: 1px solid red;"), n.add(".navigator_modal_title, .navigator_modal_titleleft, .navigator_modal_titleright", "border-top: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;color: #333;background: #f3f3f3;"), n.add(".navigator_modal_busy", "font-weight: bold;"), n.add(".navigator_modal_cell", "text-align: center;"), n.add(".navigator_modal_select .navigator_modal_cell_box", "background-color: #FFE794; opacity: 0.5;"), n.add(".navigator_modal_title", "text-align: center;"), n.add(".navigator_modal_titleleft, .navigator_modal_titleright", "text-align: center;"), n.add(".navigator_modal_dayheader", "text-align: center;"), n.add(".navigator_modal_weeknumber", "text-align: center;"), n.add(".navigator_modal_cell_text", "cursor: pointer;"), n.commit(), DayPilot2.Modal = function(e2) {
          ...
          var t2 = this;
          this.id = "_" + (/* @__PURE__ */ new Date()).getTime() + "n" + 10 * Math.random(), this.Db = false, this.Eb = null, this.Fb = null, this.showHtml = function(e3) {
            if (DayPilot2.ModalStatic.displayed(this))
            ...
            if (this.div || this.Gb(), this.Za(), this.useIframe) {
              ...
              e3.nodeType ? this.div.appendChild(e3) : this.div.innerHTML = e3;
            ...
            if (this.useIframe) {
              ...
              i2 && (this.iframe.src = "about:blank", this.setInnerHTML(this.id + "iframe", i2)), this.re(this.iframe, "load", this.Jb), this.iframe.src = e3, this.Za(), this.Hb(), this.Ib();
            } else
              t2.Kb({ "url": e3, "success": function(e4) {
            ...
            if ("function" == typeof t2.onShow) {
              var e3 = {};
              e3.root = t2.Lb(), e3.modal = t2, t2.onShow(e3);
            }
          }, this.Lb = function() {
            ...
            if (t3) {
              ...
              t3.open(i2, r2, true), t3.setRequestHeader("Content-type", "text/plain"), t3.onreadystatechange = function() {
                if (4 === t3.readyState)
                  if (200 === t3.status || 304 === t3.status) {
                    var e4 = {};
                    e4.request = t3, a2(e4);
                  } else if (n2) {
                    var e4 = {};
                    ...
                    window.console && console.log("HTTP error " + t3.status);
            ...
            }, 500), this.theme ? this.div.className = this.theme + "_main" : this.div.className = "", this.className && (this.div.className += " " + this.className), this.left ? this.div.style.left = this.left + "px" : this.div.style.marginLeft = "-" + Math.floor(this.width / 2) + "px", this.div.style.position = "absolute", this.div.style.boxSizing = "content-box", this.div.style.top = a2 + this.top + "px", this.div.style.width = this.width + "px", this.zIndex && (this.div.style.zIndex = this.zIndex), this.height && (this.useIframe || !this.autoStretch ? this.div.style.height = this.height + "px" : this.div.style.height = ""), this.useIframe && this.height && (this.iframe.style.height = this.height + "px"), this.div.style.display = "", this.Nb(), DayPilot2.ModalStatic.remove(this), DayPilot2.ModalStatic.list.push(this);
          }, this.Jb = function() {
            ...
            if (this.useIframe) {
              for (var a2 = i2() - 40, n2 = this.width; n2 < a2 && this.Ob(); n2 += 10)
                this.div.style.width = n2 + "px", this.div.style.marginLeft = "-" + Math.floor(n2 / 2) + "px";
              for (var o2 = this.maxHeight || e3() - 2 * this.top, r2 = this.height; r2 < o2 && this.Pb(); r2 += 10)
                this.iframe.style.height = r2 + "px", this.div.style.height = r2 + "px";
            ...
            this.Db || (this.re(window, "resize", this.Qb), this.re(window, "scroll", this.Rb), this.dragDrop && (this.re(document, "mousemove", this.Sb), this.re(document, "mouseup", this.Tb)), this.Db = true);
          }, this.Ub = function() {
            this.ue(window, "resize", this.Qb), this.ue(window, "scroll", this.Rb), this.dragDrop && (this.ue(document, "mousemove", this.Sb), this.ue(document, "mouseup", this.Tb)), this.Db = false;
          }, this.Vb = function(e3) {
            e3.target === t2.div && (e3.preventDefault(), t2.div.style.cursor = "move", t2.Wb(), t2.Fb = t2.mc(e3 || window.event), t2.Eb = { x: t2.div.offsetLeft, y: t2.div.offsetTop });
          }, this.Sb = function(e3) {
            if (t2.Fb) {
              var e3 = e3 || window.event, i2 = t2.mc(e3), a2 = i2.x - t2.Fb.x, n2 = i2.y - t2.Fb.y;
              t2.div.style.marginLeft = "0px", t2.div.style.top = t2.Eb.y + n2 + "px", t2.div.style.left = t2.Eb.x + a2 + "px";
            }
          }, this.Tb = function(e3) {
            t2.Fb && (t2.Xb(), t2.div.style.cursor = null, t2.Fb = null);
          }, this.Wb = function() {
            if (this.useIframe) {
              var e3 = document.createElement("div");
            ...
            for (var t3 = { x: e3.offsetLeft, y: e3.offsetTop }; e3.offsetParent; )
              e3 = e3.offsetParent, t3.x += e3.offsetLeft, t3.y += e3.offsetTop;
            return t3;
          }, this.Gb = function() {
            var e3 = t2.Zb.container(), i2 = e3 === document.body, a2 = i2 ? "fixed" : "absolute", n2 = document.createElement("div");
            ...
            var o2 = document.createElement("div");
            o2.id = this.id + "popup", o2.style.position = a2, o2.style.left = "50%", o2.style.top = "0px", o2.style.backgroundColor = "white", o2.style.width = "50px", o2.style.height = "50px", this.dragDrop && (o2.onmousedown = this.Vb), o2.addEventListener("keydown", function(e4) {
              e4.stopPropagation();
            });
            var r2 = null;
            ...
            n2.document && (n2 = n2.document), null == n2.body && n2.write("<body></body>"), i2.nodeType ? n2.body.appendChild(i2) : n2.body.innerHTML = i2, t2.autoStretch && (t2.autoStretchFirstLoadOnly && t2.$b || (t2.stretch(), t2.$b = true));
          }, this.close = function(e3) {
            this.result = e3, this.hide();
          }, this.closeSerialized = function() {
            for (var e3 = t2.Lb(), i2 = e3.querySelectorAll("input, textarea, select"), a2 = {}, n2 = 0; n2 < i2.length; n2++) {
          ...
          return DayPilot2.getPromise(function(a3, n3) {
            d2.onClosed = function(t3) {
              if (t3.result) {
                ...
                for (var o3 in t3.result)
                  e(n4, o3, t3.result[o3]);
                t3.result = n4;
              }
              a3(t3);
            };
            ...
            if (y.innerText = u, y.className = o2.theme + "_cancel", y.onclick = function(e2) {
              ...
              if ("object" == typeof o2.focus) {
                ...
                "string" == typeof o2.focus && (g = h.findViewById(o2.focus));
              g && g.focus();
            } else {
        ...
        var r = function(e2) {
          this.form = [], this.data = {}, this.theme = "form_default", this.zIndex = 99999, this.locale = "en-us", this.plugins = {}, this.onKey = null, this.cc = [], this.dc = null, this.canceling = false, this.ec = [], this.f = [], this.fc = null, e2 = e2 || {};
          for (var t2 in e2)
            this[t2] = e2[t2];
        };
        r.prototype.create = function() {
          ...
          var e2 = this;
          this.fc = document.createElement("div"), this.cc.forEach(function(t2) {
            e2.createView(t2);
          }), this.applyState();
          ...
          o2.onInput = function(e3) {
            if (e3 = e3 || {}, i2.gc(o2, { "debounce": !e3.immediate }), "function" == typeof i2.onChange) {
              var t3 = {};
              t3.result = i2.serialize(), i2.onChange(t3);
            }
          }, o2.onBlur = function() {
            i2.canceling || i2.gc(o2);
          }, o2.apply(e2), o2.fc = a2, o2.row = e2, o2.element && a2.appendChild(o2.element), this.f.push(o2), this.fc.appendChild(a2);
        ...
        }, r.prototype.gc = function(e2, t2) {
          function i2() {
            e2.hc && (e2.hc.remove(), e2.hc = null), e2.fc.classList.add(u);
            var t3 = document.createElement("div");
            t3.classList.add(h), t3.innerText = c2.message, e2.hc = t3, e2.fc.appendChild(t3);
          }
          t2 = t2 || {};
          ...
          if (d2) {
            ...
            if (c2.valid)
              clearTimeout(this.ec[o2.field]), e2.hc && (e2.hc.remove(), e2.hc = null), e2.fc.classList.remove(u);
            else if (!n2)
              if (a2) {
                var f = 1e3;
                clearTimeout(this.ec[o2.field]), this.ec[o2.field] = setTimeout(function() {
                  i2();
                }, f);
              } else
                i2();
          ...
          for (var n2 in i2)
            this.setValue(n2, i2[n2]);
        }, r.prototype.setValue = function(e2, t2) {
          this.cc.forEach(function(i2) {
            i2.applyValue(e2, t2);
          });
        }, r.prototype.updateDependentState = function() {
          var e2 = this, t2 = [true];
          (this.dc ? this.dc : this.cc).forEach(function(i2) {
          ...
          if ("radio" === a2) {
            if (e2.name) {
              var o2 = new s();
              o2.field = e2.id, o2.data = e2, o2.level = t2, o2.type = "label", o2.interactive = false, o2.text = e2.name, i2.cc.push(o2), n2.push(o2);
            }
            e2.options.forEach(function(o3) {
              var r2 = new s();
              r2.field = e2.id, r2.data = o3, r2.level = t2, r2.type = a2, r2.isValue = true, r2.text = o3.name, r2.resolved = o3.id, i2.cc.push(r2), n2.push(r2), o3.children && o3.children.forEach(function(e3) {
            ...
            var o2 = new s();
            o2.field = e2.id, o2.data = e2, o2.level = t2, o2.type = a2, o2.interactive = false, o2.text = e2.name, i2.cc.push(o2), n2.push(o2);
          } else if ("image" === a2) {
            var o2 = new s();
            o2.isValue = true, o2.field = e2.id, o2.data = e2, o2.level = t2, o2.type = a2, o2.interactive = false, o2.text = null, i2.cc.push(o2), n2.push(o2);
          } else if ("html" === a2) {
            var o2 = new s();
            o2.isValue = true, o2.field = e2.id, o2.data = e2, o2.level = t2, o2.type = a2, o2.interactive = false, o2.text = null, i2.cc.push(o2), n2.push(o2);
            ...
            var o2 = new s();
            o2.field = e2.id, o2.data = e2, o2.level = t2, o2.type = a2, o2.text = e2.name, o2.children = [], i2.cc.push(o2), n2.push(o2);
          }
          ...
          var t2 = this, i2 = { "label": function() {
            ...
            return i3.name = e2.field, e2.data.options && e2.data.options.forEach && e2.data.options.forEach(function(e3) {
              ...
              t4.innerText = e3.name || e3.id, t4.value = e3.id, t4.kc = e3.id, i3.appendChild(t4);
              ...
              a2 && "undefined" != typeof a2.kc && (t4 = a2.kc);
              var n2 = {};
            ...
            n2.type = "radio", n2.name = e2.field, n2.kc = e2.resolved, n2.onchange = function(e3) {
              var a3 = i3.row;
            ...
            var a2 = document.createElement("label"), n2 = document.createElement("input");
            n2.type = "checkbox", n2.name = e2.field, n2.kc = e2.resolved, n2.onchange = function(e3) {
              var a3 = i3.row;
          ...
          return this.cc.filter(function(t2) {
            return t2.field === e2;
          });
          ...
          var i2 = this.dc ? this.dc : this.cc, a2 = i2.indexOf(e2);
          return this.dc = i2.map(function(i3) {
            if (i3 !== e2)
              return i3;
            if (e2.propsEqual(t2))
              return e2;
        ...
        var l = function() {
          ...
          this.data = [], this.name = null, this.theme = "searchable_default", this.lc = false, this.listZIndex = 1e5, this.onSelect = null, this.nc = null, this.oc = null, this.pc = false, this.qc = null, this.rc = null, this.o = [], this.sc = null, e2 = e2 || {};
          var t2 = this, i2 = { "selected": { post: function(e3) {
            "object" == typeof e3 && e3.id ? t2.nc = e3 : "string" != typeof e3 && "number" != typeof e3 || t2.select(e3);
          } } };
          Object.defineProperty(this, "selected", { get: function() {
            ...
            this.lc = e3, this.qc && (this.qc.disabled = e3, e3 && this.tc());
          } });
          for (var a2 in e2)
            i2[a2] || (this[a2] = e2[a2]);
          for (var a2 in e2)
            i2[a2] && i2[a2].post(e2[a2]);
        };
        d.prototype.select = function(e2) {
          return this.nc = this.data.find(function(t2) {
            return t2.id === e2;
          }), this.uc(false), this;
          ...
          function e2(e3) {
            ...
            l2.data.forEach(function(i4) {
              ...
              if ("includes" === e3) {
                if (o3.toLowerCase().indexOf(m.value.toLowerCase()) === -1)
                  return;
              } else if ("startsWith" === e3 && 0 !== o3.toLowerCase().indexOf(m.value.toLowerCase()))
                return;
              var r3 = document.createElement("div");
              r3.className = l2.theme + "_list_item", r3.innerText = o3, r3.item = i4, i4 === l2.nc && (l2.oc = r3), n3 || (n3 = r3), r3.addEventListener("mousedown", function(e4) {
                a2(r3), e4.preventDefault();
              }), r3.addEventListener("mousemove", function(e4) {
                l2.oc !== r3 && (l2.oc = r3, t2({ dontScroll: true }));
          ...
          function t2(e3) {
            ...
            }), l2.oc && (l2.oc.className += " " + l2.theme + "_list_item_highlight", t3 && !i2(l2.oc, h) && l2.oc.scrollIntoView());
          }
          function i2(e3, t3) {
          ...
          function r2() {
            l2.pc = true, m.setAttribute("readonly", "readonly"), m.focus();
          }
          function s2() {
            l2.pc = false, m.removeAttribute("readonly"), m.select(), e2("all");
          }
          ...
          u.className = this.theme + "_icon", u.style.position = "absolute", u.style.right = "0", u.style.top = "0", u.style.bottom = "0", u.style.width = "20px", u.addEventListener("mousedown", function(e3) {
            e3.preventDefault(), l2.pc ? (l2.focus(), s2()) : (n2(), r2());
          });
          var h = document.createElement("div");
          h.className = this.theme + "_list", h.style.display = "none", h.style.position = "absolute", h.style.zIndex = this.listZIndex;
          var f = document.createElement("input");
          f.type = "hidden", f.name = this.name, f.searchable = d2, this.sc = f;
          var m = document.createElement("input");
          return m.type = "text", m.className = this.theme + "_input", m.disabled = this.lc, m.addEventListener("click", function(e3) {
            s2();
            ...
            if (l2.pc) {
              if ("Enter" === e3.key)
                return;
              if ("Esc" === e3.key || "Escape" === e3.key)
                return;
              s2();
            }
            if ("ArrowDown" === e3.key) {
              var i3 = d2.o.indexOf(d2.oc);
              i3 + 1 < d2.o.length && (d2.oc = d2.o[i3 + 1]), t2();
            } else if ("ArrowUp" === e3.key) {
              var i3 = d2.o.indexOf(d2.oc);
              i3 - 1 >= 0 && (d2.oc = d2.o[i3 - 1]), t2();
            } else
              "Enter" === e3.key ? l2.oc ? (e3.stopPropagation(), a2(l2.oc)) : (e3.stopPropagation(), n2(), r2()) : "Esc" !== e3.key && "Escape" !== e3.key || (e3.stopPropagation(), n2(), r2());
          }), this.qc = m, this.rc = h, this.nc || (this.nc = this.data[0], this.nc && (m.value = this.nc.name)), c2.appendChild(m), c2.appendChild(u), c2.appendChild(f), c2.appendChild(h), c2;
        }, d.prototype.tc = function() {
          this.p(), this.nc ? this.qc.value = this.nc.name : (this.qc.value = "", this.uc(true));
        }, d.prototype.focus = function() {
          this.pc = true, this.qc.setAttribute("readonly", "readonly"), this.qc.focus(), this.tc();
        }, d.prototype.p = function() {
          this.rc.style.display = "none";
        }, d.prototype.uc = function(e2) {
        ...
        var c = function(e2) {
          this.form = null, this.item = null, this.data = null, this.name = null, this.theme = "edit_table_default", this.onInput = null, this.nav = {}, this.vc = null, this.cc = [], e2 = e2 || {};
          for (var t2 in e2)
            this[t2] = e2[t2];
        };
        c.prototype.create = function() {
          ...
          return !!(e2 && this.cc.length >= e2);
        }, c.prototype.save = function() {
          var e2 = this, t2 = [];
          return e2.cc.forEach(function(e3) {
            var i2 = {};
          ...
          var e2 = this;
          this.cc = [], this.data.forEach(function(t2) {
            var i2 = e2.xc(t2);
            e2.cc.push(i2);
          });
        }, c.prototype.Ec = function(e2) {
          var t2 = this, i2 = t2.cc.indexOf(e2);
          t2.cc.splice(i2, 1);
        }, c.prototype.xc = function(e2) {
          var t2 = this, i2 = {};
          return i2.data = e2, i2.cells = [], t2.item.columns.forEach(function(a2) {
            var n2 = a2.id, o2 = e2[n2], r2 = t2.Fc(a2);
          ...
          var e2 = this;
          if (this.nav.body.innerHTML = "", this.nav.after.innerHTML = "", this.cc.forEach(function(t3) {
            var i2 = e2.yc(t3);
          ...
          return n2.className = this.theme + "_delete", n2.addEventListener("click", function(i3) {
            t2.disabled || (t2.Ec(e2), t2.zc(), t2.Ac());
          ...
          if ("text" === i2 || "number" === i2) {
            ...
            return a2.type = i2, t2.disabled && (a2.disabled = true), e2.value && (a2.value = e2.value), a2.addEventListener("keyup", function(a3) {
              "number" === i2 ? e2.value = Number(this.value) : e2.value = this.value, t2.Ac();
            }), a2;
          }
          if ("select" === i2) {
            ...
            return t2.disabled && (n2.disabled = true), e2.data.options.forEach(function(t3) {
              ...
              i3.innerText = t3.name, i3.value = t3.id, i3.kc = t3.id, n2.appendChild(i3), e2.value === t3.id && i3.setAttribute("selected", true);
            }), n2.addEventListener("change", function(i3) {
              var a3 = n2.options[n2.selectedIndex];
              a3 && "undefined" != typeof a3.kc && (e2.value = a3.kc), t2.Ac();
            }), n2;
          }
    ...
    if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function() {
      if ("undefined" == typeof DayPilot.Month || !DayPilot.Month.events) {
        ...
        e.Month = function(t, i) {
          ...
          var a = this;
          this.id = t, this.isMonth = true, this.api = 2, this.backendUrl = null, this.cellHeaderHeight = 24, this.cellHeight = 100, this.contextMenu = null, this.cssClassPrefix = "month_default", this.eventBarVisible = true, this.eventHeight = 25, this.eventsLoadMethod = "GET", this.headerHeight = 30, this.hideUntilInit = true, this.lineSpace = 1, this.locale = "en-us", this.showToolTip = true, this.startDate = new DayPilot.Date(), this.theme = null, this.visible = true, this.weekStarts = 1, this.width = "100%", this.xssProtection = "Enabled", this.afterRender = function() {
          }, this.cellHeaderClickHandling = "Enabled", this.eventClickHandling = "Enabled", this.eventDeleteHandling = "Disabled", this.eventMoveHandling = "Update", this.eventResizeHandling = "Update", this.eventRightClickHandling = "ContextMenu", this.headerClickHandling = "Enabled", this.timeRangeSelectedHandling = "Enabled", this.onCellHeaderClick = null, this.onCellHeaderClicked = null, this.onEventClick = null, this.onEventClicked = null, this.onEventDelete = null, this.onEventDeleted = null, this.onEventMove = null, this.onEventMoved = null, this.onEventResize = null, this.onEventResized = null, this.onEventRightClick = null, this.onEventRightClicked = null, this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.cellEvents = [], this.elements = {}, this.elements.events = [], this.cache = {}, this.T = function(e2, t2) {
            var e2 = JSON.parse(e2);
            return e2.CallBackRedirect ? void (document.location.href = e2.CallBackRedirect) : "None" === e2.UpdateType ? void a.fireAfterRenderDetached(e2.CallBackData, true) : (a.events.list = e2.Events, "Full" === e2.UpdateType && (a.startDate = e2.StartDate, a.timeFormat = e2.TimeFormat ? e2.TimeFormat : a.timeFormat, "undefined" != typeof e2.WeekStarts && (a.weekStarts = e2.WeekStarts), a.hashes = e2.Hashes), a.V(), a.Ic(), a.ca(), "Full" === e2.UpdateType && (a.Jc(), a.Kc()), a.ha(), a.show(), a.ia(), void a.fireAfterRenderDetached(e2.CallBackData, true));
            ...
            var t2 = null;
            if (e2 instanceof DayPilot.Event)
              t2 = e2.data;
            else {
              if ("object" != typeof e2)
            ...
            a.events.list || (a.events.list = []), a.events.list.push(t2), a.update(), a.qa.notify();
            ...
            var t2 = DayPilot.indexOf(a.events.list, e2.data);
            a.events.list.splice(t2, 1), a.update(), a.qa.notify();
            ...
            var n2 = function(e3) {
              ...
              if (DayPilot.isArray(i3)) {
                ...
                if (s2.preventDefault = function() {
                  ...
                  return;
                a.events.list = i3, a.za && a.update();
              }
            };
            if (a.eventsLoadMethod && "POST" === a.eventsLoadMethod.toUpperCase())
              DayPilot.Http.ajax({ "method": "POST", "data": { "start": a.visibleStart().toString(), "end": a.visibleEnd().toString() }, "url": e2, "success": o, "error": n2 });
            else {
          ...
          }, this.fb = {}, this.fb.events = [], this.gb = function(e2) {
            var t2 = this.fb.events, i2 = this.events.list[e2], n2 = {};
            for (var o in i2)
              n2[o] = i2[o];
            if ("function" == typeof this.onBeforeEventRender) {
              var r = {};
            ...
            if (e2) {
              if (!DayPilot.isArray(e2))
                throw new DayPilot.Exception("DayPilot.Month.events.list expects an array object. You supplied: " + typeof e2);
              if ("function" == typeof this.onBeforeEventRender)
                for (var t2 = 0; t2 < e2.length; t2++)
                  this.gb(t2);
              for (var i2 = 0; i2 < e2.length; i2++) {
                ...
                if (!(n2.getTime() > o.getTime()))
                  for (var t2 = 0; t2 < this.rows.length; t2++) {
                    var r = this.rows[t2], s = new DayPilot.Event(a2, this);
                    r.belongsHere(s) && (r.events.push(s), "function" == typeof this.onBeforeEventRender && (s.cache = this.fb.events[i2]));
                  }
              }
            ...
            this.elements.events = [];
            for (var e2 = 0; e2 < this.rows.length; e2++)
              for (var t2 = this.rows[e2], i2 = 0; i2 < t2.lines.length; i2++)
                for (var a2 = t2.lines[i2], n2 = 0; n2 < a2.length; n2++)
                  this.Ca(a2[n2]);
          }, this.hb = function(e2, t2) {
            if (!(e2 && t2 && e2.start && t2.start))
              return 0;
            ...
            if (this.shadow) {
              for (var e2 = 0; e2 < this.shadow.list.length; e2++)
                this.nav.top.removeChild(this.shadow.list[e2]);
              this.shadow = null, this.nav.top.style.cursor = "";
            }
          }, this.getEventTop = function(e2, t2) {
            for (var i2 = this.headerHeight, a2 = 0; a2 < e2; a2++)
              i2 += this.rows[a2].getHeight();
            ...
            u.setAttribute("unselectable", "on"), u.style.height = this.eventHeight + "px", u.className = this.J("_event"), i2.cssClass && DayPilot.Util.addClass(u, i2.cssClass), t2.part.startsHere || DayPilot.Util.addClass(u, this.J("_event_continueleft")), t2.part.endsHere || DayPilot.Util.addClass(u, this.J("_event_continueright")), u.event = t2, u.style.width = d + "%", u.style.position = "absolute", u.style.left = l + "%", u.style.top = c + "px", this.showToolTip && t2.client.toolTip() && (u.title = t2.client.toolTip()), u.onclick = a.pa, u.oncontextmenu = a.Mc, u.onmousedown = function(i3) {
              i3 = i3 || window.event;
              ...
              if (i3.cancelBubble = true, i3.stopPropagation && i3.stopPropagation(), 1 === l2) {
                if (e.movingEvent = null, "w-resize" === this.style.cursor || "e-resize" === this.style.cursor) {
                  ...
                  a.clearShadow();
                  var c2 = DayPilot.mo2(a.nav.top, i3);
                  if (!c2)
                    return;
            ...
            for (var n2 = 0; n2 < e2; n2++) {
              ...
              o.start = this.firstDate.addDays(7 * n2), o.end = o.start.addDays(this.getColCount()), o.events = [], o.lines = [], o.index = n2, o.minHeight = this.cellHeight, o.calendar = this, o.belongsHere = function(e3) {
                ...
                for (var n3 = this, o2 = 0; o2 < this.lines.length; o2++) {
                  var r = this.lines[o2];
                  if (r.isFree(t3, i3))
                    return r.addEvent(e3, t3, i3, a2, o2), o2;
                }
                var r = [];
                return r.isFree = function(e4, t4) {
                  for (var i4 = true, a3 = 0; a3 < this.length; a3++)
                    e4 + t4 - 1 < this[a3].part.colStart || e4 > this[a3].part.colStart + this[a3].part.colWidth - 1 || (i4 = false);
                  return i4;
                ...
                for (var e3 = 0, t3 = 0; t3 < a.rows.length && t3 < this.index; t3++)
                  e3 += a.rows[t3].getHeight();
            ...
            for (var e2 = this.headerHeight, t2 = 0; t2 < this.rows.length; t2++)
              e2 += this.rows[t2].getHeight();
            return e2;
            ...
            this.nav.events = n2, n2.style.position = "absolute", n2.style.left = "0px", n2.style.right = "0px", n2.setAttribute("unselectable", "on"), t2.appendChild(n2), t2.onmousemove = function(t3) {
              if (e.resizingEvent) {
                var i3 = DayPilot.mo2(a.nav.top, t3);
                if (!i3)
                  return;
                ...
                if ("w-resize" === s.direction) {
                  ...
                  r = a.getCellFromDate(s.event.start()), o = a.getWidth(r, n3);
                o < 1 && (o = 1), a.drawShadow(r.x, r.y, 0, o);
              } else if (e.movingEvent) {
                var i3 = DayPilot.mo2(a.nav.top, t3);
                if (!i3)
                  return;
                if (i3.x === e.movingEvent.coords.x && i3.y === e.movingEvent.coords.y)
                  return;
            ...
            for (var e2 = 0; e2 < this.cells.length; e2++)
              for (var t2 = 0; t2 < this.cells[e2].length; t2++)
                this.cells[e2][t2].style.top = this.getRowTop(t2) + "px", this.cells[e2][t2].style.height = this.rows[t2].getHeight() + "px";
            ...
            for (var t2 = DayPilot.DateUtil.daysDiff(this.firstDate, e2), i2 = { x: 0, y: 0 }; t2 >= 7; )
              i2.y++, t2 -= 7;
            return i2.x = t2, i2;
          }, this.Kc = function() {
            var e2 = document.createElement("div");
            ...
            for (var e2 = 0; e2 < this.cells.length; e2++)
              for (var t2 = 0; t2 < this.cells[e2].length; t2++)
                this.cells[e2][t2].onclick = null;
            this.nav.cells.innerHTML = "";
          }, this.oa = function() {
            return 2 === a.api;
          }, this.Nc = function(t2, i2, o) {
            var r = this.rows[i2], s = this.firstDate.addDays(7 * i2 + t2), l = document.createElement("div");
            if (l.setAttribute("unselectable", "on"), l.style.position = "absolute", l.style.cursor = "default", l.style.left = this.getCellWidth() * t2 + "%", l.style.width = this.getCellWidth() + "%", l.style.top = this.getRowTop(i2) + "px", l.style.height = r.getHeight() + "px", l.className = this.J("_cell"), !this.isWeekend(s)) {
            ...
            c.setAttribute("unselectable", "on"), l.appendChild(c), c.style.position = "absolute", c.style.left = "0px", c.style.right = "0px", c.style.top = "0px", c.style.bottom = "0px", c.className = this.J("_cell_inner"), l.onmousedown = function(n2) {
            ...
            var u = document.createElement("div");
            u.setAttribute("unselectable", "on"), u.style.height = this.cellHeaderHeight + "px", u.className = this.J("_cell_header"), u.onclick = function(e2) {
            ...
            var h = s.getDay();
            1 === h ? u.innerHTML = n.locale().monthNames[s.getMonth()] + " " + h : u.innerHTML = h, c.appendChild(u), this.cells[t2][i2] = l, o.appendChild(l);
            ...
            for (var t2 = this.headerHeight, i2 = 0; i2 < e2; i2++)
              t2 += this.rows[i2].getHeight();
            return t2;
            ...
            var e2 = this;
            return a.ra(e2.event), false;
          }, this.ra = function(e2) {
            if (this.event = e2, !e2.client.rightClickEnabled())
              return false;
            var t2 = {};
          ...
          this.debug = function(e2, t2) {
            ...
            var e2 = a;
            e2.nav.top && (e2.V(), e2.nav.top.removeAttribute("style"), e2.nav.top.removeAttribute("class"), e2.nav.top.innerHTML = "", e2.nav.top.dp = null, e2.nav.top.onmousemove = null, e2.nav.top = null);
          }, this.Ya = function() {
          ...
          }, this.internal = {}, this.internal.loadOptions = this._a, this.internal.xssTextHtml = a.Ia, this.init = function() {
            return this.eb(), this.loadFromServer() ? void this.kb() : (this.Ic(), this.ca(), this.Ea(), this.Kc(), this.s(), this.ia(), this.Ya(), this.fireAfterRenderDetached(null, false), this.za = true, this);
      ...
      if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.nav) {
        DayPilot.Navigator = function(e, t) {
          ...
          this.id = e, this.api = 2, this.isNavigator = true, this.autoFocusOnClick = true, this.weekStarts = "Auto", this.selectMode = "Day", this.titleHeight = 30, this.dayHeaderHeight = 30, this.bound = null, this.cellWidth = 30, this.cellHeight = 30, this.cssClassPrefix = "navigator_default", this.freeHandSelectionEnabled = false, this.selectionStart = new DayPilot.Date().getDatePart(), this.selectionEnd = null, this.selectionDay = null, this.showMonths = 1, this.skipMonths = 1, this.command = "navigate", this.year = new DayPilot.Date().getYear(), this.month = new DayPilot.Date().getMonth() + 1, this.showWeekNumbers = false, this.weekNumberAlgorithm = "Auto", this.rowsPerMonth = "Six", this.orientation = "Vertical", this.locale = "en-us", this.rtl = false, this.visible = true, this.timeRangeSelectedHandling = "Bind", this.visibleRangeChangedHandling = "Enabled", this.onVisibleRangeChange = null, this.onVisibleRangeChanged = null, this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.nav = {}, this.fb = {}, this.Oc = function() {
            ...
            e2.type = "hidden", e2.name = i.id + "_state", e2.id = e2.name, this.root.appendChild(e2), this.state = e2, this.startDate ? this.startDate = new DayPilot.Date(this.startDate).firstDayOfMonth() : this.startDate = DayPilot.Date.fromYearMonthDay(this.year, this.month), this.calendars = [], this.selected = [], this.months = [];
          }, this.oa = function() {
            return 2 === i.api;
          }, this.Jc = function() {
            this.root.innerHTML = "";
            ...
            if (v.style.width = m + "px", v.style.height = p + "px", "Horizontal" === this.orientation)
              v.style.position = "absolute", v.style.left = m * e2 + "px", v.style.top = "0px", a2.top = 0, a2.left = m * e2;
            else {
            ...
            if (this.showWeekNumbers)
              for (var C = 0; C < h; C++) {
                ...
                k.style.position = "absolute", k.style.left = "0px", k.style.right = "0px", k.style.top = C * this.cellHeight + g + "px", k.style.width = o.cellWidth() + "px", k.style.height = this.cellHeight + "px", k.style.lineHeight = this.cellHeight + "px", k.setAttribute("unselectable", "on"), k.className = this.J("_weeknumber"), k.innerHTML = "<span>" + _ + "</span>", v.appendChild(k), a2.weeks.push(k);
              }
            for (var S = 0; S < 7; S++) {
              a2.cells[S] = [];
              var k = document.createElement("div");
              k.style.position = "absolute", k.style.left = S * o.cellWidth() + w + "px", k.style.right = S * o.cellWidth() + w + "px", k.style.top = this.titleHeight + "px", k.style.width = o.cellWidth() + "px", k.style.height = this.dayHeaderHeight + "px", k.style.lineHeight = this.dayHeaderHeight + "px", k.setAttribute("unselectable", "on"), k.className = this.J("_dayheader"), k.innerHTML = "<span>" + this.Uc(S) + "</span>", v.appendChild(k), a2.days.push(k);
              for (var C = 0; C < h; C++) {
                var P = d.addDays(7 * C + S), M = this.Vc(P) && "none" !== this.Wc(), T = P.firstDayOfMonth() === n2, A = P < n2, E = P >= n2.addMonths(1);
                if ("month" === this.Wc())
                  M = M && T;
                else if ("day" === this.Wc())
                  M = M && (T || r && A || s && E);
                else if ("week" === this.Wc()) {
                  var H = P.firstDayOfMonth() === n2;
                  M = M && (H || r && A || s && E);
                }
                ...
                if (R && DayPilot.Util.addClass(N, R.cssClass || R.css), T || r && A || s && E) {
                  ...
                  B.innerHTML = P.getDay(), B.style.position = "absolute", B.style.left = "0px", B.style.top = "0px", B.style.right = "0px", B.style.bottom = "0px", i.Qc(B, "cell_text"), N.isClickable = true, R && R.html && (B.innerHTML = R.html), N.appendChild(B);
                }
                N.setAttribute("unselectable", "on"), N.onclick = this.Yc, v.appendChild(N), M && (i.Zc(v, S, C), this.selected.push(N));
              }
            }
            var j = document.createElement("div");
            j.style.position = "absolute", j.style.left = "0px", j.style.top = g - 2 + "px", j.style.width = 7 * o.cellWidth() + this.Pc() + "px", j.style.height = "1px", j.style.fontSize = "1px", j.style.lineHeight = "1px", j.className = this.J("_line"), v.appendChild(j), this.months.push(a2);
          }, this.Xc = function(e2, t2) {
            var i2 = this.titleHeight + this.dayHeaderHeight, a2 = this.Pc();
            return { "x": e2 * o.cellWidth() + a2, "y": t2 * this.cellHeight + i2 };
          }, this.Zc = function(e2, t2, a2) {
              ...
              for (var e2 = 0; e2 < this.showMonths; e2++)
                for (var t2 = 0; t2 < 7; t2++)
                  for (var i2 = 0; i2 < 6; i2++) {
                    ...
                    a2 && (1 === this.items[a2.day.toStringSortable()] ? (this.Qc(a2, "busy"), this.Rc(a2, "free")) : (this.Rc(a2, "busy"), this.Qc(a2, "free")));
                  }
          }, this.ad = function() {
            var e2 = {};
            ...
            switch (e2 || (e2 = DayPilot.Date.today()), e2 = new DayPilot.Date(e2), this.Wc()) {
              case "day":
          ...
          }, this.cd = null, this.select = function(e2, t2, a2) {
            ...
            if (d) {
              ...
              (this.selectionStart < this.dd() || this.selectionStart >= this.ed()) && (m = this.selectionStart.firstDayOfMonth()), m.toStringSortable() !== this.startDate.toStringSortable() && (f = true), this.startDate = m;
            }
            ...
            if (i._a(e2), this.za) {
              ...
              i.Za(), t2.start === i.selectionStart && t2.end == i.selectionEnd && t2.day === i.selectionDay || i.L();
            }
          }, this.Za = function() {
            ...
            if ("function" == typeof i.onAjaxError) {
              ...
              "function" == typeof i.ajaxError && i.ajaxError(e2);
          }, this.S = function(e2) {
            i.T(e2.responseText);
            ...
            for (var t2 = 0; t2 < i.months.length; t2++) {
              ...
              if (!a2)
                return null;
              if (e2.x < a2.left || a2.width < e2.x)
                return null;
              i.months[t2].height;
              if (a2.top <= e2.y && e2.y < a2.top + a2.height)
                return t2;
            }
            return null;
          }, this.nd = function(e2) {
            ...
            if (n2.top <= t2.y && t2.y < n2.top + o2)
              return { "month": a2, "x": 0, "y": 0, "coords": t2, "header": true };
            for (var r = 0; r < n2.cells.length; r++)
              for (var s = 0; s < n2.cells[r].length; s++) {
                var l = n2.cells[r][s], d = l.top + n2.top, c = l.left + n2.left;
                if (c <= t2.x && t2.x < c + i.cellWidth && d <= t2.y && t2.y < d + i.cellHeight)
                  return { "month": a2, "x": r, "y": s, "coords": t2 };
              }
            return null;
          }, this.od = function(e2) {
          ...
          a.start = null, a.drawCell = function(e2) {
            var t2 = i.months[e2.month], n2 = i.Xc(e2.x, e2.y), o2 = t2.top + n2.y, r = t2.left + n2.x, s = document.createElement("div");
            ...
            if (a.cells) {
              for (var e2 = 0; e2 < a.cells.length; e2++)
                i.nav.preselection.removeChild(a.cells[e2]);
              a.cells = [];
            }
          }, a.draw = function() {
          ...
          var n = function(e2, t2, a2) {
            ...
            if ("object" == typeof e2) {
              ...
              this.month = e2, this.x = t2, this.y = a2;
            this.is = function(e3) {
              return this.month === e3.month && this.x === e3.x && this.y === e3.y;
            }, this.next = function() {
              var e3 = this;
              if (e3.x < 6)
                return { "month": e3.month, "x": e3.x + 1, "y": e3.y };
              ...
              i.months[e3.month];
              if (e3.y > 0)
                return { "month": e3.month, "x": 6, "y": e3.y - 1 };
              if (e3.month > 0) {
          ...
          this.Yc = function(e2) {
            ...
            if (a2.cells[n2][o2].isClickable) {
              ...
              switch (i.Wc()) {
                ...
                case "day":
                  ...
                  i.Zc(t2, n2, o2), i.selected.push(l), i.selectionStart = l.day, i.selectionEnd = l.day;
                  break;
                case "week":
                  if (i.autoFocusOnClick) {
                  ...
                  for (var c = 0; c < 7; c++)
                    i.Zc(t2, c, o2), i.selected.push(a2.cells[c][o2]);
                ...
                case "month":
                  ...
                  for (var s = null, d = null, o2 = 0; o2 < 6; o2++)
                    for (var n2 = 0; n2 < 7; n2++) {
                      var l = a2.cells[n2][o2];
                      l && l.day.getYear() === r.getYear() && l.day.getMonth() === r.getMonth() && (i.Zc(t2, n2, o2), i.selected.push(l), null === s && (s = l.day), d = l.day);
                    }
            ...
            if (e2 = e2 || {}, i.oa()) {
              ...
              if (r.start = t2, r.end = a2, r.day = o2, r.days = n2, r.mode = e2.mode || i.selectMode, r.preventDefault = function() {
                this.preventDefault.value = true;
              }, "function" == typeof i.onTimeRangeSelect && (i.onTimeRangeSelect(r), r.preventDefault.value))
                return;
            ...
            this.startDate = this.startDate.addMonths(e2), this.Jc(), this.Oc(), this.fd(), this.ad(), this.gd(), this._c();
          }, this.dd = function() {
            ...
            if (i.oa()) {
              ...
              if (a2.start = e2, a2.end = t2, a2.preventDefault = function() {
                this.preventDefault.value = true;
              }, "function" == typeof i.onVisibleRangeChange && (i.onVisibleRangeChange(a2), a2.preventDefault.value))
                return;
            ...
            var e2 = JSON.parse(e2);
            i.items = e2.Items, i.cells = e2.Cells, i.cells ? i.update() : i._c();
          }, this.fd = function() {
            for (var e2 = 0; e2 < this.showMonths; e2++) {
              var t2 = this.sd(e2);
              this.Kc(e2, t2);
          ...
          }, this.internal = {}, this.internal.loadOptions = i._a, this.internal.initialized = function() {
            return i.za;
          }, this._ = {};
          var o = this._;
          o.locale = function() {
            ...
            return e2 || (e2 = i.cellWidth), i.fb.cellWidth = e2, e2;
          }, this.clearSelection = function() {
            for (var e2 = 0; e2 < this.selected.length; e2++) {
              var t2 = this.selected[e2];
              i.$c(t2.parentNode, t2.x, t2.y);
            }
            this.selected = [];
          }, this.vd = function() {
            ...
            for (var t2 = new DayPilot.Date(e2.start), i2 = new DayPilot.Date(e2.end), a2 = {}, n2 = t2.getDatePart(); n2.getTime() <= i2.getTime(); )
              a2[n2.toStringSortable()] = 1, n2 = n2.addDays(1);
            return a2;
          }, this.show = function() {
            ...
            if (this.eb(), !this.root.dp) {
              ...
              if (this.vd() && this.gd(), this.za = true, this.db(), this.cd) {
                var e2 = this.cd;
                this.select(e2.date1, e2.date2, e2.options), this.cd = null;
              }
              return this;
            }
          }, this.xd = function() {
            ...
            if (a.start && a.end) {
              ...
              if (t2.x === a.start.coords.x && t2.y === a.start.coords.y)
                return a.start = null, void a.clear();
              a.clear();
              var o2 = a.ordered();
              o2.start = new n(o2.start).nextVisible(), o2.end = new n(o2.end).previousVisible(), i.selectionDay = new n(o2.start).date(), i.selectionStart = i.selectionDay, i.selectionEnd = new n(o2.end).date(), a.start = null, a.end = null, i.Jc(), i.Oc(), i.fd(), i._c(), i.ad();
              i.L({ "mode": "FreeHand" });
            }
            a.start = null, a.end = null;
          }, this.dispose = function() {
            var e2 = i;
            e2.root && (e2.root.removeAttribute("style"), e2.root.removeAttribute("class"), e2.root.dp = null, e2.root.innerHTML = null, e2.root = null, e2.hd = true);
          }, this.Y = function() {
